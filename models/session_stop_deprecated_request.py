...
class SessionStopDeprecatedRequest(object):
    ...
    def __init__(self, name=None, logout=None):  # noqa: E501
        """SessionStopDeprecatedRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._logout = None
    ...
    @property
    def name(self):
        """Gets the name of this SessionStopDeprecatedRequest.  # noqa: E501

        Session name (id)  # noqa: E501

        :return: The name of this SessionStopDeprecatedRequest.  # noqa: E501
        :rtype: object
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SessionStopDeprecatedRequest.

        Session name (id)  # noqa: E501

        :param name: The name of this SessionStopDeprecatedRequest.  # noqa: E501
        :type: object
        """
        if name is None:
    ...
    @property
    def logout(self):
        """Gets the logout of this SessionStopDeprecatedRequest.  # noqa: E501

        Stop and logout from the session.  # noqa: E501

        :return: The logout of this SessionStopDeprecatedRequest.  # noqa: E501
        :rtype: object
        """
        return self._logout
    ...
    def logout(self, logout):
        """Sets the logout of this SessionStopDeprecatedRequest.

        Stop and logout from the session.  # noqa: E501

        :param logout: The logout of this SessionStopDeprecatedRequest.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SessionStopDeprecatedRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SessionStopDeprecatedRequest):
            return False
