...
class StopResponse(object):
    ...
    def __init__(self, stopping=None):  # noqa: E501
        """StopResponse - a model defined in Swagger"""  # noqa: E501
        self._stopping = None
    ...
    @property
    def stopping(self):
        """Gets the stopping of this StopResponse.  # noqa: E501

        Always 'true' if the server is stopping.  # noqa: E501

        :return: The stopping of this StopResponse.  # noqa: E501
        :rtype: object
        """
    ...
    def stopping(self, stopping):
        """Sets the stopping of this StopResponse.

        Always 'true' if the server is stopping.  # noqa: E501

        :param stopping: The stopping of this StopResponse.  # noqa: E501
        :type: object
        """
        if stopping is None:
            raise ValueError("Invalid value for `stopping`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StopResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StopResponse):
            return False
