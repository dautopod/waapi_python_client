...
class SettingsSecurityChangeInfo(object):
    ...
    def __init__(self, admins_only=None):  # noqa: E501
        """SettingsSecurityChangeInfo - a model defined in Swagger"""  # noqa: E501
        self._admins_only = None
        self.discriminator = None
        self.admins_only = admins_only

    @property
    def admins_only(self):
        """Gets the admins_only of this SettingsSecurityChangeInfo.  # noqa: E501


        :return: The admins_only of this SettingsSecurityChangeInfo.  # noqa: E501
        :rtype: object
        """
        return self._admins_only

    @admins_only.setter
    def admins_only(self, admins_only):
        """Sets the admins_only of this SettingsSecurityChangeInfo.


        :param admins_only: The admins_only of this SettingsSecurityChangeInfo.  # noqa: E501
        :type: object
        """
        if admins_only is None:
            raise ValueError("Invalid value for `admins_only`, must not be `None`")  # noqa: E501

        self._admins_only = admins_only
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SettingsSecurityChangeInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SettingsSecurityChangeInfo):
            return False
