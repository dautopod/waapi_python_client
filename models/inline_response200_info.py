...
class InlineResponse200Info(object):
    ...
    def __init__(self, status=None):  # noqa: E501
        """InlineResponse200Info - a model defined in Swagger"""  # noqa: E501
        self._status = None
    ...
    @property
    def status(self):
        """Gets the status of this InlineResponse200Info.  # noqa: E501


        :return: The status of this InlineResponse200Info.  # noqa: E501
        :rtype: object
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this InlineResponse200Info.


        :param status: The status of this InlineResponse200Info.  # noqa: E501
        :type: object
        """
        if status is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse200Info, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse200Info):
            return False
