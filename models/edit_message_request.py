...
class EditMessageRequest(object):
    ...
    def __init__(self, text=None):  # noqa: E501
        """EditMessageRequest - a model defined in Swagger"""  # noqa: E501
        self._text = None
    ...
    @property
    def text(self):
        """Gets the text of this EditMessageRequest.  # noqa: E501


        :return: The text of this EditMessageRequest.  # noqa: E501
        :rtype: object
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this EditMessageRequest.


        :param text: The text of this EditMessageRequest.  # noqa: E501
        :type: object
        """
        if text is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EditMessageRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EditMessageRequest):
            return False
