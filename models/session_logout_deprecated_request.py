...
class SessionLogoutDeprecatedRequest(object):
    ...
    def __init__(self, name=None):  # noqa: E501
        """SessionLogoutDeprecatedRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this SessionLogoutDeprecatedRequest.  # noqa: E501

        Session name (id)  # noqa: E501

        :return: The name of this SessionLogoutDeprecatedRequest.  # noqa: E501
        :rtype: object
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SessionLogoutDeprecatedRequest.

        Session name (id)  # noqa: E501

        :param name: The name of this SessionLogoutDeprecatedRequest.  # noqa: E501
        :type: object
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SessionLogoutDeprecatedRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SessionLogoutDeprecatedRequest):
            return False
