...
class CustomHeader(object):
    ...
    def __init__(self, name=None, value=None):  # noqa: E501
        """CustomHeader - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._value = None
    ...
    @property
    def name(self):
        """Gets the name of this CustomHeader.  # noqa: E501


        :return: The name of this CustomHeader.  # noqa: E501
        :rtype: object
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CustomHeader.


        :param name: The name of this CustomHeader.  # noqa: E501
        :type: object
        """
        if name is None:
    ...
    @property
    def value(self):
        """Gets the value of this CustomHeader.  # noqa: E501


        :return: The value of this CustomHeader.  # noqa: E501
        :rtype: object
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this CustomHeader.


        :param value: The value of this CustomHeader.  # noqa: E501
        :type: object
        """
        if value is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CustomHeader, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CustomHeader):
            return False
