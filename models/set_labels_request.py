...
class SetLabelsRequest(object):
    ...
    def __init__(self, labels=None):  # noqa: E501
        """SetLabelsRequest - a model defined in Swagger"""  # noqa: E501
        self._labels = None
    ...
    @property
    def labels(self):
        """Gets the labels of this SetLabelsRequest.  # noqa: E501


        :return: The labels of this SetLabelsRequest.  # noqa: E501
        :rtype: object
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this SetLabelsRequest.


        :param labels: The labels of this SetLabelsRequest.  # noqa: E501
        :type: object
        """
        if labels is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SetLabelsRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetLabelsRequest):
            return False
