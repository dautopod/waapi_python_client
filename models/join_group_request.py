...
class JoinGroupRequest(object):
    ...
    def __init__(self, code=None):  # noqa: E501
        """JoinGroupRequest - a model defined in Swagger"""  # noqa: E501
        self._code = None
    ...
    @property
    def code(self):
        """Gets the code of this JoinGroupRequest.  # noqa: E501

        Group code (123) or url (https://chat.whatsapp.com/123)  # noqa: E501

        :return: The code of this JoinGroupRequest.  # noqa: E501
        :rtype: object
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this JoinGroupRequest.

        Group code (123) or url (https://chat.whatsapp.com/123)  # noqa: E501

        :param code: The code of this JoinGroupRequest.  # noqa: E501
        :type: object
        """
        if code is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JoinGroupRequest, dict):
