...
class CaptchaBody(object):
    ...
    def __init__(self, code=None):  # noqa: E501
        """CaptchaBody - a model defined in Swagger"""  # noqa: E501
        self._code = None
    ...
    @property
    def code(self):
        """Gets the code of this CaptchaBody.  # noqa: E501


        :return: The code of this CaptchaBody.  # noqa: E501
        :rtype: object
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this CaptchaBody.


        :param code: The code of this CaptchaBody.  # noqa: E501
        :type: object
        """
        if code is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CaptchaBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CaptchaBody):
            return False
