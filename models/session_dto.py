...
class SessionDTO(object):
    ...
    def __init__(self, name=None, status=None, config=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this SessionDTO.  # noqa: E501

        Session name (id)  # noqa: E501

        :return: The name of this SessionDTO.  # noqa: E501
        :rtype: object
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SessionDTO.

        Session name (id)  # noqa: E501

        :param name: The name of this SessionDTO.  # noqa: E501
        :type: object
        """
        if name is None:
    ...
    @property
    def status(self):
        """Gets the status of this SessionDTO.  # noqa: E501


        :return: The status of this SessionDTO.  # noqa: E501
        :rtype: object
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this SessionDTO.


        :param status: The status of this SessionDTO.  # noqa: E501
        :type: object
        """
        if status is None:
    ...
    @property
    def config(self):
        """Gets the config of this SessionDTO.  # noqa: E501


        :return: The config of this SessionDTO.  # noqa: E501
        :rtype: SessionConfig
        """
        return self._config
    ...
    def config(self, config):
        """Sets the config of this SessionDTO.


        :param config: The config of this SessionDTO.  # noqa: E501
        :type: SessionConfig
        """
