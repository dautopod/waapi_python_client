...
class OTPRequest(object):
    ...
    def __init__(self, code=None):  # noqa: E501
        """OTPRequest - a model defined in Swagger"""  # noqa: E501
        self._code = None
    ...
    @property
    def code(self):
        """Gets the code of this OTPRequest.  # noqa: E501


        :return: The code of this OTPRequest.  # noqa: E501
        :rtype: object
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this OTPRequest.


        :param code: The code of this OTPRequest.  # noqa: E501
        :type: object
        """
        if code is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OTPRequest):
            return False
