...
class WAHAChatPresences(object):
    ...
    def __init__(self, id=None, presences=None):  # noqa: E501
        """WAHAChatPresences - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this WAHAChatPresences.  # noqa: E501

        Chat ID - either group id or contact id  # noqa: E501

        :return: The id of this WAHAChatPresences.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this WAHAChatPresences.

        Chat ID - either group id or contact id  # noqa: E501

        :param id: The id of this WAHAChatPresences.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    @property
    def presences(self):
        """Gets the presences of this WAHAChatPresences.  # noqa: E501


        :return: The presences of this WAHAChatPresences.  # noqa: E501
        :rtype: object
        """
    ...
    def presences(self, presences):
        """Sets the presences of this WAHAChatPresences.


        :param presences: The presences of this WAHAChatPresences.  # noqa: E501
        :type: object
        """
        if presences is None:
            raise ValueError("Invalid value for `presences`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WAHAChatPresences, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WAHAChatPresences):
            return False
