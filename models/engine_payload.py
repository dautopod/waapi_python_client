...
class EnginePayload(object):
    ...
    def __init__(self, event=None, data=None):  # noqa: E501
        """EnginePayload - a model defined in Swagger"""  # noqa: E501
        self._event = None
        self._data = None
    ...
    @property
    def event(self):
        """Gets the event of this EnginePayload.  # noqa: E501


        :return: The event of this EnginePayload.  # noqa: E501
        :rtype: object
        """
        return self._event
    ...
    def event(self, event):
        """Sets the event of this EnginePayload.


        :param event: The event of this EnginePayload.  # noqa: E501
        :type: object
        """
        if event is None:
    ...
    @property
    def data(self):
        """Gets the data of this EnginePayload.  # noqa: E501


        :return: The data of this EnginePayload.  # noqa: E501
        :rtype: object
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this EnginePayload.


        :param data: The data of this EnginePayload.  # noqa: E501
        :type: object
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnginePayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnginePayload):
            return False
