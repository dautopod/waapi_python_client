...
class VoiceRemoteFile(object):
    ...
    def __init__(self, mimetype=None, url=None):  # noqa: E501
        """VoiceRemoteFile - a model defined in Swagger"""  # noqa: E501
        self._mimetype = None
        self._url = None
    ...
    @property
    def mimetype(self):
        """Gets the mimetype of this VoiceRemoteFile.  # noqa: E501

        MIME type of the attachment.  # noqa: E501

        :return: The mimetype of this VoiceRemoteFile.  # noqa: E501
        :rtype: object
        """
    ...
    def mimetype(self, mimetype):
        """Sets the mimetype of this VoiceRemoteFile.

        MIME type of the attachment.  # noqa: E501

        :param mimetype: The mimetype of this VoiceRemoteFile.  # noqa: E501
        :type: object
        """
        if mimetype is None:
    ...
    @property
    def url(self):
        """Gets the url of this VoiceRemoteFile.  # noqa: E501


        :return: The url of this VoiceRemoteFile.  # noqa: E501
        :rtype: object
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this VoiceRemoteFile.


        :param url: The url of this VoiceRemoteFile.  # noqa: E501
        :type: object
        """
        if url is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VoiceRemoteFile, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VoiceRemoteFile):
            return False
