...
class SessionStartDeprecatedRequest(object):
    ...
    def __init__(self, name=None, config=None):  # noqa: E501
        """SessionStartDeprecatedRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._config = None
    ...
    @property
    def name(self):
        """Gets the name of this SessionStartDeprecatedRequest.  # noqa: E501

        Session name (id)  # noqa: E501

        :return: The name of this SessionStartDeprecatedRequest.  # noqa: E501
        :rtype: object
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SessionStartDeprecatedRequest.

        Session name (id)  # noqa: E501

        :param name: The name of this SessionStartDeprecatedRequest.  # noqa: E501
        :type: object
        """
        if name is None:
    ...
    @property
    def config(self):
        """Gets the config of this SessionStartDeprecatedRequest.  # noqa: E501


        :return: The config of this SessionStartDeprecatedRequest.  # noqa: E501
        :rtype: SessionConfig
        """
        return self._config
    ...
    def config(self, config):
        """Sets the config of this SessionStartDeprecatedRequest.


        :param config: The config of this SessionStartDeprecatedRequest.  # noqa: E501
        :type: SessionConfig
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SessionStartDeprecatedRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SessionStartDeprecatedRequest):
            return False
