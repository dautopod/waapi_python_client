...
class DeleteStatusRequest(object):
    ...
    def __init__(self, id=None, contacts=None):  # noqa: E501
        """DeleteStatusRequest - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._contacts = None
    ...
    @property
    def id(self):
        """Gets the id of this DeleteStatusRequest.  # noqa: E501

        status message id  # noqa: E501

        :return: The id of this DeleteStatusRequest.  # noqa: E501
        :rtype: object
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DeleteStatusRequest.

        status message id  # noqa: E501

        :param id: The id of this DeleteStatusRequest.  # noqa: E501
        :type: object
        """
        if id is None:
    ...
    @property
    def contacts(self):
        """Gets the contacts of this DeleteStatusRequest.  # noqa: E501

        Contact list to send the status to.  # noqa: E501

        :return: The contacts of this DeleteStatusRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def contacts(self, contacts):
        """Sets the contacts of this DeleteStatusRequest.

        Contact list to send the status to.  # noqa: E501

        :param contacts: The contacts of this DeleteStatusRequest.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeleteStatusRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteStatusRequest):
            return False
