...
class PinMessageRequest(object):
    ...
    def __init__(self, duration=None):  # noqa: E501
        """PinMessageRequest - a model defined in Swagger"""  # noqa: E501
        self._duration = None
    ...
    @property
    def duration(self):
        """Gets the duration of this PinMessageRequest.  # noqa: E501

        Duration in seconds. 24 hours (86400), 7 days (604800), 30 days (2592000)  # noqa: E501

        :return: The duration of this PinMessageRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def duration(self, duration):
        """Sets the duration of this PinMessageRequest.

        Duration in seconds. 24 hours (86400), 7 days (604800), 30 days (2592000)  # noqa: E501

        :param duration: The duration of this PinMessageRequest.  # noqa: E501
        :type: object
        """
        if duration is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PinMessageRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PinMessageRequest):
            return False
