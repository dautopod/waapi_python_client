...
class WAReaction(object):
    ...
    def __init__(self, text=None, message_id=None):  # noqa: E501
        """WAReaction - a model defined in Swagger"""  # noqa: E501
        self._text = None
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this WAReaction.

        Reaction to the message. Either the reaction (emoji) or empty string to remove the reaction  # noqa: E501

        :param text: The text of this WAReaction.  # noqa: E501
        :type: object
        """
        if text is None:
    ...
    @property
    def message_id(self):
        """Gets the message_id of this WAReaction.  # noqa: E501

        Message ID for the message to react to  # noqa: E501

        :return: The message_id of this WAReaction.  # noqa: E501
        :rtype: object
        """
    ...
    def message_id(self, message_id):
        """Sets the message_id of this WAReaction.

        Message ID for the message to react to  # noqa: E501

        :param message_id: The message_id of this WAReaction.  # noqa: E501
        :type: object
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WAReaction):
            return False
