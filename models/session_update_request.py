...
class SessionUpdateRequest(object):
    ...
    def __init__(self, config=None):  # noqa: E501
        """SessionUpdateRequest - a model defined in Swagger"""  # noqa: E501
        self._config = None
    ...
    @property
    def config(self):
        """Gets the config of this SessionUpdateRequest.  # noqa: E501


        :return: The config of this SessionUpdateRequest.  # noqa: E501
        :rtype: SessionConfig
        """
        return self._config
    ...
    def config(self, config):
        """Sets the config of this SessionUpdateRequest.


        :param config: The config of this SessionUpdateRequest.  # noqa: E501
        :type: SessionConfig
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SessionUpdateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SessionUpdateRequest):
            return False
